...
save(fullfile(homedir,sprintf('sust_trans_%d_%d.mat',ubegin,uend)),'sust_trans','ubegin','uend','i','path')
end
...
% trials1=trials(:,14)==1&trials(:,15)==1&trials(:,9)==2;
% trials2=trials(:,14)==1&trials(:,15)==1&trials(:,9)==16;
