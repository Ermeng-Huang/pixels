...
processed_images_folder = 'D:\histology\dualtask\M40\processed';
...
save_location = 'D:\histology\dualtask\M40\results';
...
probe_lengths = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]; 
...
% red and blue?
red_and_blue = true;
RBlabels = [ones(8,1)*[1,0.3,0.3];ones(8,1)*[0.3,0.3,1];ones(8,1)*[0.3,0.3,1];ones(8,1)*[1,0.3,0.3]];
...
pause(.05)
Probe_length(selected_probe,1)=probe_length_histo*10;
end
saveas(fwireframe,[save_location '\overview.fig']);
save([save_location '\HistLength'],'Probe_length')
close