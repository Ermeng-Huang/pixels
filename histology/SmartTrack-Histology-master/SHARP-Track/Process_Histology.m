...
% silcenum=length(dir('D:\NP-histology\*_*'));
silcenum=length(dir('K:\Raw Data\DPA8s\M2\2-*'));
% directory of histology images
% Image4register_folder0 = 'D:\NP-histology\Npxl_42_';
Image4register_folder0 = 'K:\Raw Data\DPA8s\M2\2-';
% Image4ROIs_folder = 'I:\Raw Data\M13\13_6';
% directory to save the processed images -- can be the same as the above image_folder
% results will be put inside a new folder called 'processed' inside of this image_folderduia
save_folder = 'D:\histology\DPA8s\M2';
...
folder_processed_images4reg = fullfile(save_folder, 'processed');
...
for i=1:silcenum
    ...
    Image4register_folder=[Image4register_folder0 num2str(i)];
