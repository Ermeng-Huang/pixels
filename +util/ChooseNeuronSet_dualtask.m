function out=ChooseNeuronSet_dualtask(homedir,opt)
arguments    
    homedir (1,:) char = 'F:/pixel-dualtask';
    ...
    opt.selfile (1,:) char='1129'
    opt.trial (1,:) char = 'distractorNo'
    opt.pref (1,:) logical = false
end
if strcmp(opt.selfile,'0907')|| strcmp(opt.selfile,'1129')
